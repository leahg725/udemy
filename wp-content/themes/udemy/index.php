<?php get_header(); ?>
	...
	<section id="content">
		...
		<div class="content-wrap">
            <?php if(!is_single() && is_home() && function_exists('wpp_get_mostpopular') && get_theme_mod('lu_show_header_popular_posts_widget')) :
                wpp_get_mostpopular(array(
                    'wpp_start' => '<div class="section header-stick bottommargin-lg clearfix" style="padding: 20px 0;">
                            <div>
                                <div class="container clearfix">
                                    <span class="label label-danger bnews-title">' . get_theme_mod('lu_popular_posts_widget_title') . ':</span>
